...
def measure_memory(func, *args, **kwargs):
    ...
    tracemalloc.stop()
    mem = f"{peak / 1024**2:.2f} MB"  # Convert bytes to MB
    return res, mem
...
if __name__ == "__main__":
    ...
    paths = [r"E:\MSImaging-data\_msi_visual\Extractions\metaspace_datasets\Dataset5_kidney\0.npy"]
            ...
            if os.path.exists(dst_path):
                ...
                try:
                    if name == "PHATE3D_BKA":
                        ...
                        # else:
                        visualizations[name], mem = measure_memory(method, img)
