...
class AnnotatorState:
    ...
    def __init__(self) -> None:
        ...
        self.config_override_path: Optional[Path] = None
        ...
        self.sweep: Optional[dict] = None  # parameter-sweep progress / results
        # Optional absolute dirs (None = repo defaults). Persisted separately in paths.json.
        self.app_output_dir: Optional[str] = None
        self.panel_output_dir: Optional[str] = None
